 ...
 *
 * @ClassName: basic.skiplist.SkipList
 * @Description: 该类的功能描述
 * @version: v1.0.0
 * @author: xuecy
...
public class SkipList<T> {
    ...
    private int nodes;// node的数量
    private int listLevel; // 跳跃表的层数
    private Random random;
    private static final double PROBABILITY = 0.5;// 提升概率
    ...
    public static void main(String[] args) {
        ...
        list.put(1, "chun");
        list.put(3, "yang");
        list.put(1, "thinkings");//测试同一个key值
        list.put(4, "地");
        list.put(6, "球");
        list.put(5, "超");
        list.put(8, "人");
